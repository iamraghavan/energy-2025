    ...
    <Card className="w-full shadow-lg border-primary/20 bg-card overflow-hidden">
        <CardHeader className="pb-2 bg-muted/30 border-b">
            <CardTitle className="flex justify-between items-center text-lg md:text-xl">
                 <Badge variant="destructive" className="text-base px-3 py-1">LIVE</Badge>
      ...
      <CardContent className="p-4 md:p-6">
        <div className="grid grid-cols-2 items-center gap-4 text-center">
          ...
          <div className="flex flex-col items-center justify-center gap-3 p-4 bg-secondary/50 rounded-lg">
            ...
            <h3 className="text-2xl md:text-3xl font-bold text-foreground text-center line-clamp-2 h-20">{team1Name}</h3>
          ...
          <div className="flex flex-col items-center justify-center gap-3 p-4 bg-secondary/50 rounded-lg">
            ...
            <h3 className="text-2xl md:text-3xl font-bold text-foreground text-center line-clamp-2 h-20">{team2Name}</h3>
